...
const About = () => {
  ...
  return (
    <section className="bg-color logo-white">
          ...
          <div className="display-our">
            ...
            <ul className="ourMissionList">
              ...
              <li className="listRight">
                Harness the power of innovation to <br></br>create user-centric
                SaaS products.
              </li>
              <li className="listRight color-gray">
                Stay at the forefront of technological<br></br> advancements to
                consistently exceed<br></br> client expectations.
              </li>
              <li className="color-gray">
                Foster long-term partnerships by <br></br>delivering exceptional
                customer value.
              </li>
            </ul>
          </div>
      ...
      <div className="about-diffrence">
        <div className="container">
          <div className="row">
            <h1>The CloudMojo Difference</h1>
        ...
        <img
          ...
          src="./images/about-animation.png"
        />
      </div>

      <div className="about-focus">
        <img className="about-diffrenc-img" src="./images/our_focus_area.png" />
        <div className="container">
          <div className="row">
            ...
            <div className="about-main">
              ...
              <div className="about-col-2">
                ...
                <p>
                  ...
                  repetitive tasks, optimize workflows, and unlock new levels of
                  efficiency. Our goal is to provide you with the tools to boost
              ...
              <div className="about-col-3">
                ...
                <p>
                  ...
                  solutions. We understand the nuances of the financial industry
                  and have developed cutting-edge products that streamline
                  processes, enhance security, and drive unprecedented growth
                  for your business.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p>
                  ...
                  challenges and turning them into opportunities for innovation.
                  Our approach is simple yet powerful - we tackle complex
                  requirements with the aim of productizing solutions that not
                  only propel businesses forward but also contribute to making a
